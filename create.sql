...
CREATE INDEX genre_IDX ON genres_movies(genre) TABLESPACE TAB_16k;
...
CREATE UNIQUE INDEX nick_IDX ON users(nick) TABLESPACE TAB_16k;
...
CREATE INDEX citizenID_IDX ON contracts(citizenID) TABLESPACE TAB_16k;
...
CREATE INDEX member_IDX ON membership(nick) TABLESPACE TAB_16k;
